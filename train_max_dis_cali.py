...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='./save/proto-cali-max-dis-5-5-2')
...
#            print(label)
            ...
            loss2 = loss_fn1(new_proto, old_proto.view(5, -1))
            loss = loss1 + loss2 + loss3
            acc = count_acc(logits, label)
            print('epoch {}, train {}/{}, loss1={:.6f} loss2={:.6f} loss3={:.6f} acc={:.6f}'
                  .format(epoch, i, len(train_loader), loss1.item(), loss2.item(), loss3.item(), acc))

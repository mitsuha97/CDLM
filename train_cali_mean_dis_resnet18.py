...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='./save_WHURS19_resnet18/proto-cali-mean-dis-5-5-1')
...
#            print(label)
            ...
            print('epoch {}, train {}/{}, loss1={:.6f} loss2={:.6f} loss4={:.6f} acc={:.6f}'
                  .format(epoch, i, len(train_loader), loss1.item(), loss2.item(), loss4.item(), acc))
